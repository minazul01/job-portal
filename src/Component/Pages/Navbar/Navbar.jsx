    ...
    <>
      <div className="navbar">
        <div className="navbar-start">
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ...
                    (isActive ? "text-[#3B9DF8] font-bold" : "")
                  }
                >
                  Home
                </NavLink>
          ...
          <Link
            to="/"
            className="text-xl md:text-2xl lg:text-5xl text-[#3C65F5] font-bold flex items-center"
          >
            <img src={Logo} alt="" />
            Job portals
          </Link>
        ...
        <div className="navbar-end">
          {user ? (
            <button
              onClick={logOut}
              className="text-xl font-medium p-3 bg-[#3C65F5] rounded-lg cursor-pointer hover:bg-gray-200"
            >
              Logout
            </button>
          ) : (
            <>
              ...
              <Link
                to="/login"
                className="text-xl font-medium p-3 ml-7 bg-[#3C65F5] rounded-lg cursor-pointer hover:bg-gray-200"
              >
                Login
              </Link>
            </>
